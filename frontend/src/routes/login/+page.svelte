...
<div class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg w-96">
        ...
        <div class="mt-2 items-center flex justify-center text-sm text-gray-400">Don't have an account yet?&nbsp; <a href='/register' class="text-blue-400 hover:text-blue-700"> Register here</a></div>
